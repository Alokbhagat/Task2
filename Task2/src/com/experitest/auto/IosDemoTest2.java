...
public class IosDemoTest2 extends BaseTest {
	...
	public void webExperitestTest() {
		  ...
		  new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@nodeName='BUTTON' and @css='BUTTON.navbar-toggle']")));
